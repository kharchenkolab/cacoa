...
clusterFreeZScoreMat <- function(adj_mat, count_mat, is_control, min_z = 0.01, verbose = TRUE, n_cores = 1L) {
    .Call('_cacoa_clusterFreeZScoreMat', PACKAGE = 'cacoa', adj_mat, count_mat, is_control, min_z, verbose, n_cores)
}
